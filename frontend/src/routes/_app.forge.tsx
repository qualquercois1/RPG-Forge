...
function ForgePage() {
  ...
  const valid = total === TOTAL_POINTS && name.trim().length > 0;
  ...
  const submit = () => {
    ...
    navigate({ to: "/character/$id", params: { id: String(created.id) } });
  };
  ...
  return (
    <div className="p-6 md:p-10 max-w-4xl mx-auto">
      ...
      <div className="space-y-6">
        <Card className="p-6">
          <h2 className="font-display text-2xl mb-4">Identidade</h2>
        ...
        <Card className="p-6">
          <h2 className="font-display text-2xl mb-4">Físico</h2>
        ...
        <Card className="p-6">
          <h2 className="font-display text-2xl mb-4">Lore</h2>
          <textarea
            value={lore}
        ...
        <div className="flex justify-end">
          <Button size="lg" disabled={!valid} onClick={submit} className="font-semibold">
